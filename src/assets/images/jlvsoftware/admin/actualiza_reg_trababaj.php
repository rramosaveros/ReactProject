	        ...
	        ?>
       		 <form action="modificausu.php" method="post">
                            <table>
                                <tr>
                                    <td>
                                        <input name="ci" class="input" type="text" placeholder="&#128100; Cédula de Identidad (Sin guión)" required autofocus maxlength="10"  value="<?= $datos['usuario_user'];?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input class="input" type="text" placeholder="&#1664; Contraseña" required maxlength="30" name="contrasenia" value="<?= $datos['usuario_pass'];?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input class="input" type="text" placeholder="&#9742; Teléfono" required maxlength="30" name="telefono" value="<?= $datos['usuario_telef'];?>">
                                    </td>
                                </tr>
                            </table>       
