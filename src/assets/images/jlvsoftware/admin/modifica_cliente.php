...
<html>
    ...
    <body>
        ...
        <header>
		    ...
		    ?>
		    <br><H6>MODIFICAR REGISTRO DE CLIENTES</H6>
		    <table class="tabla">
		    <tr>
		  ...
		  $row["cliente_cedula"],$row["cliente_nombre"],$row["cliente_nombrecomercial"],$row["cliente_direccion"],$row["cliente_ruta"],$row["cliente_provincia"],$row["cliente_ciudad"],$row["cliente_canton"],$row["cliente_correo"],$row["cliente_telefono"],$row["cliente_celular"],$row["cliente_id"]);
		        }
		        $result->free_result();
		        $conn->close();
		        ?>
