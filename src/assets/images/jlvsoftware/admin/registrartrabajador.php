                    ...
                    if(!isset($_POST["verificar"]))
                    {
                        ...
                        <form action="agregar_registro.php" method="post">
                            <table align="center">
                                ...
                                <tr>
                                    <td>
                                        <input class="input" type="text" placeholder="&#1664; Contraseña" required maxlength="30" name="contrasenia">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input class="input" type="text" placeholder="&#9742; Teléfono" required maxlength="10" name="telefono">
                                    </td>
                                </tr>
                            </table>
